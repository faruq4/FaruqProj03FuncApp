...
def main(msg: func.ServiceBusMessage):
    ...
    connection = psycopg2.connect(dbname="techconfdb", user="faruq@faruqndproj03postgreedb", password="Miran@2018", host="faruqndproj03postgreedb.postgres.database.azure.com")
